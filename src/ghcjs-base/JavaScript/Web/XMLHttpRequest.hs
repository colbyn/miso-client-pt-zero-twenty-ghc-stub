...
module JavaScript.Web.XMLHttpRequest
    ( xhr
    , xhrByteString
    , xhrText
    , xhrString
...
js_getAllResponseHeaders = stub

js_getResponseHeader :: JSString -> XHR -> IO JSVal
js_getResponseHeader = stub
