...
-- ~
import Core hiding (isObject, isSymbol, isNumber)
...
js_isBoolean   :: JSVal -> Bool
js_isBoolean = stub

js_isNumber    :: JSVal -> Bool
js_isNumber = stub

js_isString    :: JSVal -> Bool
js_isString = stub

js_isSymbol    :: JSVal -> Bool
js_isSymbol = stub

js_isFunction  :: JSVal -> Bool
js_isFunction = stub
